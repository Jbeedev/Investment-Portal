  ...
  return (
    <div>
      <nav class=" container mx-auto flex bg-white items-center justify-between flex-wrap p-5    ">
        ...
        <div class=" w-full hidd bg-white text-2xl flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <div className="text-2xl">
            <a
              href="/"
              class="inline-block  px-4 py-2 leading-none rounded  mt-4 lg:mt-0 mr-3"
            >
              Sign In
            </a>
            <a
